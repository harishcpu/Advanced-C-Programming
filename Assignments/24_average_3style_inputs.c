/* Title : Average of n numbers(input in 3 different ways)
 * Author : Harish
 * Date : 21 Dec
 * Description : export ary=12345, get the numbers either from COMMAND LINE or ENV or STDIN, print the average.
 */
